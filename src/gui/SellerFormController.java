...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("") || txtBaseSalary.getText().equals("0.00")) {
...
// LocalDate date = dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault()).toLocalDate();
 ...
 //dpBirthDate.setValue(LocalDate.ofInstant(entity.getBirthDate().toInstant(), ZoneId.systemDefault());
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		lblErrorName.setText((fields.contains("name") ? errors.get("name") : errors.get("")));
		lblErrorEmail.setText((fields.contains("email") ? errors.get("email") : errors.get("")));
		lblErrorBirthDate.setText((fields.contains("birthDate") ? errors.get("birthDate") : errors.get("")));
		lblErrorBaseSalary.setText((fields.contains("baseSalary") ? errors.get("baseSalary") : errors.get("")));
		lblErrorDepartment.setText((fields.contains("baseSalary") ? errors.get("baseSalary") : errors.get("")));
	}
